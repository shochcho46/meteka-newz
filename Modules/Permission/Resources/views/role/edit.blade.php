        ...
        <div class="col-xxl-4 col-xl-4 col-md-6 col-sm-10">
            ...
            <form action="{{ route('role.update',$data->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-style mb-30">
                    <h4 class="mb-25">{{ __('webstring.edit') }} {{ __('webstring.permission_role') }}</h4>

                   
                    <div class="col-12">
                        <div class="input-style-2">
                        <label for="name" class="form-label">{{ __('webstring.permission_role_name') }}</label>
                        <input type="text" class="form-control" id="name" name="name" placeholder="{{ __('webstring.permission_role_name') }}"  value="{{ old('name') ?? $data->name  }}" >
