...
<div class="row">
    ...
    <div class="col-xxl-8 col-xl-8 col-md-10 col-sm-10">
        <div class="card-style mb-30">
            <h4 class="mb-25">{{ __('webstring.add') }} {{ __('webstring.album') }}</h4>

            <form action="{{ route('albam.store') }}" method="POST" id="postfrom" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="name" name="name" placeholder="{{ __('webstring.album_name') }}"  value="{{ old('name') }}" >
                 ...
                 <div class="col-12">
                    <h6 class="mb-25">{{ __('webstring.album_slider') }}</h6>
                    <div class="ml-5 row ">
                         <div class="col-3 form-check radio-style mb-20 ">
                             <input class="form-check-input" type="radio" name="slider" value="1" checked  required/>
                             <label class="form-check-label" for="radio-1">{{ __('webstring.active') }}</label>
                         </div>
     
                         <div class=" col-3 form-check radio-style mb-20">
                             <input class="form-check-input" type="radio" name="slider" value="0"  />
