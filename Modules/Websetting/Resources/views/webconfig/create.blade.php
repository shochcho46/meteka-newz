        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('websetting.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                  <h3 class="card-title text-center text-capitalize">{{ __('webstring.add') }} {{ __('webstring.webconfig') }}</h3>
                    <div class="row">

                        <div class="col-6">
                           <label for="logotext" class="form-label">{{ __('webstring.text') }} {{ __('webstring.logo') }}</label>
                            <input type="text" class="form-control" id="logotext" name="logotext" placeholder="{{ __('webstring.text') }} {{ __('webstring.logo') }}" value="{{ old('logotext') }}" required>
                         ...
                         <div class="col-6">
                            <label for="apptitle" class="form-label">{{ __('webstring.app') }} {{ __('webstring.title') }}</label>
                             <input type="text" class="form-control" id="apptitle" name="apptitle" placeholder="{{ __('webstring.app') }} {{ __('webstring.title') }}" value="{{ old('apptitle') }}" >
