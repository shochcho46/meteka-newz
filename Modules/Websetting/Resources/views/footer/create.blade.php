    ...
    <div class=" col-xl-6 col-xxl-6 col-md-6 col-sm-12 ">
       <form action="{{ route('footer.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-style mb-30">
                    <h6 class="mb-25">{{ __('webstring.add') }} {{ __('webstring.footer') }}</h6>

                    <div class="col-12">
                        <div class="input-style-2">
                        <label for="contact" class="form-label">{{ __('webstring.contact') }}</label>
                        <input type="number" class="form-control" id="contact" name="contact" placeholder="{{ __('webstring.contact') }}" step="1" value="{{ old('contact') }}" required>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="house" name="house" placeholder="{{ __('webstring.house_placeholder') }} " value="{{ old('house') }}" required>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="road" name="road" placeholder="{{ __('webstring.road') }}" value="{{ old('road') }}" required>
                    ...
                    <div class="col-12">
                        <div class="input-style-2">
                            ...
                            <input type="text" class="form-control" id="location" name="location" placeholder="{{ __('webstring.location') }}" value="{{ old('location') }}" required>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="location_text" name="location_text" placeholder="{{ __('webstring.location_text') }}" value="{{ old('location_text') }}" >
                    ...
                    <div class="col-12">
                        <label for="footer_detail" class="form-label">{{ __('webstring.footer_detail') }}</label>
                         <div class="input-style-3">
                            ...
                            <textarea placeholder="{{ __('webstring.message') }}" rows="5" class="form-control" id="footer_detail" name="footer_detail" required>{{ old('footer_detail') }}</textarea>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="copyright" name="copyright" placeholder="{{ __('webstring.copy_right') }}" value="{{ old('copyright') }}" required>
