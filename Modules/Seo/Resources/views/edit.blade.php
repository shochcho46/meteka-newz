                                ...
                                <div class="card-body">
                                    @include('common.message')
                                        <form action="{{ route('seo.update',$data->id) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <h3 class="card-title text-center text-capitalize">{{ __('webstring.edit') }} {{ __('webstring.seo') }}</h3>
                                            <div class="row g-3">

                                                <div class="col-12">
                                                    <label for="keyword" class="form-label">{{ __('webstring.key_word') }}</label>
                                                    <input type="text" class="form-control" id="keyword" name="keyword" placeholder="{{ __('webstring.key_word') }}" value="{{ old('keyword') ?? $data->keyword }}" >
                                                ...
                                                <label for="title" class="form-label">{{ __('webstring.title') }}</label>
                                                    <input type="text" class="form-control" id="title" name="title" placeholder="{{ __('webstring.title') }}" value="{{ old('title') ?? $data->title }}" >
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <input type="number" class="form-control" id="refresh" name="refresh" placeholder="{{ __('webstring.refresh') }} {{ __('webstring.time') }}" value="{{ old('refresh') ?? $data->refresh }}" min="1">
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" class="form-control" id="gverify" name="gverify" placeholder="{{ __('webstring.google_verification') }}" value="{{ old('gverify') ?? $data->gverify }}" >
                                                </div>
