        ...
        function s(i, n, d) {
            ...
            if (n.files && n.files[0]) {
                ...
                if ("" == p || "" != p && s.size / 1e3 <= p) {
                    ...
                    c.onload = function(e) {
                        a(d).find('img[data-spartanindexi="' + r + '"]').hide(), a(d).find('a[data-spartanindexremove="' + r + '"]').show(), a(d).find('img[data-spartanindeximage="' + r + '"]').attr("src", e.target.result), a(d).find('img[data-spartanindeximage="' + r + '"]').show(), i.onRenderedPreview.call(this, r), 1 == i.directUpload.status && function(i, e, n) {
                            var t = a(e).data("spartanindexinput"),
                                d = new FormData,
                                r = e.files[0],
                                o = i.directUpload.additionalParam;
                            a(n).find('[data-spartanindexloader="' + t + '"]').css("display", "flex"), d.append("file", r), void 0 !== o && a.each(o, function(a, i) { d.append(a, i) });
                            a.ajax({ url: i.directUpload.url, type: "POST", data: d, cache: !1, processData: !1, contentType: !1, success: function(e, d, r) { a(n).find('[data-spartanindexloader="' + t + '"]').css("display", "none"), void 0 !== i.directUpload.success && i.directUpload.success(this, e, d, r) }, error: function(e, d, r) { a(n).find('[data-spartanindexloader="' + t + '"]').css("display", "none"), void 0 !== i.directUpload.error && i.directUpload.error(this, e, d, r) } })
                        }(i, n, d)
                    }, c.readAsDataURL(n.files[0]);
                    var g = !1;
                    0 == a(d).find('img[data-spartanindeximage="' + r + '"]').is(":visible") && (t++, g = !0), r == e - 1 && g && ("" == i.maxCount ? o(i, d) : "" != i.maxCount && t < i.maxCount && o(i, d))
                } else if ("" != p && s.size / 1e3 > p) return 1 == a(d).find('img[data-spartanindeximage="' + r + '"]').is(":visible") && a(d).find('img[data-spartanindexi="' + r + '"]').hide(), i.onSizeErr.call(this, r, s), !1
            }
        }
        return this.each(function() {
            var i = this;
            o(r, i), a(this).on("change", ".spartan_image_input", function() { s(r, this, i) }), a(this).on("click", ".spartan_remove_row", function() {
                ! function(i, e, d) {
                    var r = a(e).data("spartanindexremove");
                    a(d).find('[data-spartanindexrow="' + r + '"]').remove(), n != r && 1 != a(d).find('img[data-spartanindeximage="' + n + '"]').is(":visible") || o(i, d), t--, i.onRemoveRow.call(this, r)
                }(r, this, i)
            }), a(this).on("dragenter dragover dragstart", ".spartan_item_wrapper", function(i) {
                var e, n;
                i.stopPropagation(), i.preventDefault(), n = a(e = this).data("spartanindexrow"), a(e).find(".file_upload").css({ "border-color": "#5FAAE1", background: "#DBE9F3" }), 0 == a(e).find('img[data-spartanindeximage="' + n + '"]').is(":visible") && (a(e).find('p[data-spartanlbldropfile="' + n + '"]').show(), a(e).find('img[data-spartanindexi="' + n + '"]').hide())
            }), a(this).on("dragleave", ".spartan_item_wrapper", function() {
                var i, e;
                e = a(i = this).data("spartanindexrow"), a(i).find(".file_upload").css({ "border-color": "#ddd", background: "none" }), 0 == a(i).find('img[data-spartanindeximage="' + e + '"]').is(":visible") && (a(i).find('p[data-spartanlbldropfile="' + e + '"]').hide(), a(i).find('img[data-spartanindexi="' + e + '"]').show())
            }), a(this).on("drop", ".spartan_item_wrapper", function(e) {
                var n, t, d, o, l;
                e.stopPropagation(), e.preventDefault(), t = i, d = e, o = a(n = this).data("spartanindexrow"), (l = a(t).find('.spartan_image_input[data-spartanindexinput="' + o + '"]')).files = d.originalEvent.dataTransfer.files, a(n).find(".file_upload").css({ "border-color": "#ddd", background: "none" }), a(n).find('p[data-spartanlbldropfile="' + o + '"]').hide(), a(n).find('img[data-spartanindexi="' + o + '"]').show(), s(r, l, t)
            })
        })
    }
}(jQuery);