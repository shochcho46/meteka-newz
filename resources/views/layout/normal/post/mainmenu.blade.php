...
<div class="row">
  ...
  <div class="col-sm-12 col-xs-12 col-md-12 col-lg-8 col-xl-8 col-xxl-8">
    ...
    <div class="row">
        ...
        <div class="col-12 col-xl-4 col-xxl-4 col-lg-4 col-md-4 col-sm-6 mt-2 mb-2 text-dark">
            <a class="hvr-bounce-out" href="{{ route('home.newsWithSlug',[$secondrowValue->id, $secondrowValue->post->slug]) }}">
                <div class=" threeColbox shadow rounded text-center">
                    ...
                    <div class="p-1 text-start">
                        ...
                        <div class="d-none d-md-block p-1 text-dark text-start"><strong> {{ Str::limit($secondrowValue->post->head, 25, '...'); }}</strong></div>
                    </div>
